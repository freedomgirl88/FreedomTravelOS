...
export function useTripStore(){
  ...
  const [days,setDays]=useLocalStorage("ftos-days-v13",defaultExploreDays);
  ...
  return {trip,packing,expenses,days,selectedDay,setSelectedDay,visited,favourites,bookings,memories,packed,packingProgress,spentSGD,remainingSGD,activeDay,activeVisited,exploreProgress,ready,updateTripField,updateFlightField,updateHotelField,updateReturnFlightField,togglePacking,addPackingItem,addExpense,deleteExpense,toggleVisited,toggleFavourite,addBooking,deleteBooking,addMemory,deleteMemory,resetAll};
}
