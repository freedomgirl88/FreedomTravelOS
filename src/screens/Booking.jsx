...
export default function Booking({ store }) {
  ...
  return <Page>
    ...
    <Card className="storage verified-card verified-card-v6"><ShieldCheck size={20}/><div><strong>Current verified hotel price</strong><p><b>Shilla Stay Mapo: S$247.91 total / S$123.96 per night.</b> Previous hotel price is unknown because it was not recorded.</p></div></Card>
