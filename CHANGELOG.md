...
- Budget, packing, airport, document, itinerary and readiness queries.
...
## 2.1.0 — Smart Assistant Pro
- Added actionable on-device packing recommendations.
- Added one-tap pre-flight reminder suggestions.
- Added itinerary coaching based on saved plans.
- Added improved budget, packing and weather guidance without sending personal data externally.

## 2.3.0 — Ultimate Korea Companion
- Added concert readiness, merchandise planning, tax refund, photography planning and expanded Korea tools.

## 2.5.0-rc.2 — Performance + Polish
- Lazy-loaded secondary screens with an accessible loading state.
- Debounced and background-flushed local data persistence.
- Hardened flight reminder validation.
- Improved Personal Edition service-worker caching strategy.
- Added reduced-motion, focus, wrapping, touch-target and long-page performance polish.

## 2.5.0 RC4
- Rebuilt Assistant chat composer and mobile quick prompts.
- Rebuilt Documents and Emergency forms with shared premium controls.
- Fixed Emergency contact names wrapping letter by letter.
- Added full-width responsive emergency call cards.
- Removed the extra footer layer beneath Save actions.
